...
!function(t) {
  ...
  var d, m = Object.prototype, v = m.hasOwnProperty, g = "function" == typeof Symbol ? Symbol : {}, w = g.iterator || "@@iterator", b = g.asyncIterator || "@@asyncIterator", L = g.toStringTag || "@@toStringTag", x = "object" == ("undefined" == typeof module ? "undefined" : e(module)), E = t.regeneratorRuntime;
  if (E) x && (module.exports = E); else {
      (E = t.regeneratorRuntime = x ? module.exports : {}).wrap = r;
      var S = "suspendedStart", _ = "suspendedYield", j = "executing", O = "completed", k = {}, G = {};
      G[w] = function() {
          return this;
      };
