// import {
//   getStickyPosts as _getStickyPosts,
...
Page({
  ...
  getStickyPosts: function () {
    // var t = this;
    // _getStickyPosts().then(function (e) {
    //   t.setData({
    //     stickyPost: e
    //   });
    // }).catch(function (e) {
  ...
  getCategories: function () {
    // var t = this;
    // _getCategories().then(function (e) {
    //   t.setData({
    //     category: e
    //   });
    // }).catch(function (e) {
  ...
  getPostList: function (t) {
    var a = this;
    getPostsList(t).then(function (e) {
      var t = {};
